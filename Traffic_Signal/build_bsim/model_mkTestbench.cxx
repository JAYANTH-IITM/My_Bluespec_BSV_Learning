...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 INST_top.DEF_cs__h74 = INST_top.INST_cs.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_begin_state_change = !((INST_top.DEF_cs__h74) == (tUInt8)0u);
	 INST_top.DEF_WILL_FIRE_RL_begin_state_change = INST_top.DEF_CAN_FIRE_RL_begin_state_change;
	 if (INST_top.DEF_WILL_FIRE_RL_begin_state_change)
	   INST_top.RL_begin_state_change();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_cs.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
time_t MODEL_mkTestbench::get_creation_time()
{
  ...
  /* Thu Oct 24 08:54:00 UTC 2024 */
  return 1729760040llu;
}
