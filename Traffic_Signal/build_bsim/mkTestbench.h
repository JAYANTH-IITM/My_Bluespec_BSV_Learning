...
class MOD_mkTestbench : public Module {
 ...
 public:
  tUInt8 DEF_WILL_FIRE_RL_begin_state_change;
  tUInt8 DEF_CAN_FIRE_RL_begin_state_change;
  tUInt8 DEF_cs__h74;
 
 /* Local definitions */
 private:
  std::string DEF_IF_IF_cs_EQ_0_THEN_1_ELSE_IF_cs_EQ_1_THEN_2_EL_ETC___d16;
  std::string DEF_IF_cs_EQ_1_THEN_STR_Yellow_ELSE_IF_cs_EQ_2_THE_ETC___d7;
 
 /* Rules */
 public:
  void RL_begin_state_change();
